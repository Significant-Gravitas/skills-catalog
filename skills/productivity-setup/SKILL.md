...
metadata:
  ...
  source: anthropics/knowledge-work-plugins/productivity/skills/start
  source_url: https://github.com/anthropics/knowledge-work-plugins/blob/1c7187c4fc17feefa6cde39517f12dae1249e6c4/productivity/skills/start/SKILL.md
...
**If `TASKS.md` doesn't exist:** Create it with the standard template (see [task-management guidance](references/task-management.md)). Place it in the current working directory.

**If `dashboard.html` doesn't exist:** Copy it from `assets/dashboard.html` in this skill package to the current working directory.
