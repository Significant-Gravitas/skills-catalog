...
3. **Online sleuthing** — Sales Safari and watering-hole mining (see [source-guides.md](source-guides.md))
...
Safari is passive (you observe) where interviews are active (you ask). Run it first: it tells you what to ask about, and in whose words. For per-platform search operators and extraction tips, see [source-guides.md](source-guides.md).
...
- **Analyze what you gather** with the Mode 1 extraction framework in [SKILL.md](../SKILL.md) (jobs to be done, pains, triggers, outcomes, language, alternatives) and the confidence guardrails.
- **Mine public sources** (the passive Safari half) via [source-guides.md](source-guides.md).
