# Attribution: recruiting-pipeline

Original skill: `recruiting-pipeline`.
Original author: Anthropic and upstream contributors
Source: https://github.com/anthropics/knowledge-work-plugins/blob/1c7187c4fc17feefa6cde39517f12dae1249e6c4/human-resources/skills/recruiting-pipeline/SKILL.md
...
- `SKILL.md` from `anthropics/knowledge-work-plugins/human-resources/skills/recruiting-pipeline/SKILL.md`: Use the clear installed name, standard licence and string-valued attribution metadata; preserve all other upstream fields and body. Normalize equivalent tool-list separators where required.; Identify adapted files while retaining upstream authorship and licence.
- `LICENSE` from `anthropics/knowledge-work-plugins/LICENSE`: Copied unchanged.

## Runtime requirements

- Current requisitions/candidate stages and timestamps; pasted data or an ATS connector
- ATS status writes are native behavior when connected; connector permissions must be supported
